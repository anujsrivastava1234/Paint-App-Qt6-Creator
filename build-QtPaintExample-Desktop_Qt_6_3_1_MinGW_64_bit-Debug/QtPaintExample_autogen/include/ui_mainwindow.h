...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon7;
        icon7.addFile(QString::fromUtf8(":/images/red.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionRed->setIcon(icon7);
        ...
        QIcon icon8;
        icon8.addFile(QString::fromUtf8(":/images/green.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionGreen->setIcon(icon8);
        actionYellow = new QAction(MainWindow);
        actionYellow->setObjectName(QString::fromUtf8("actionYellow"));
        QIcon icon9;
        icon9.addFile(QString::fromUtf8(":/images/yellow.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionYellow->setIcon(icon9);
